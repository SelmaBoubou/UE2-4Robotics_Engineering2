...
class NavTest():
    def __init__(self):
        ...
        locations['pos1'] = Pose(Point(-1.415, 0.834, 0.000), Quaternion(0.000, 0.000, -0.263, 0.965))
        locations['pos2'] = Pose(Point(-0.803, 2.365, 0.000), Quaternion(0.000, 0.000, 0.974, 0.226))
        locations['pos3'] = Pose(Point(-3.388, 3.632, 0.000), Quaternion(0.000, 0.000, 0.868, -0.497))
        locations['pos4'] = Pose(Point(-4.625, 1.055, 0.000), Quaternion(0.000, 0.000, -0.223, 0.975))
        locations['pos5'] = Pose(Point(-2.301, 0.123, 0.000), Quaternion(0.000, 0.000, -0.149, 0.989))
        locations['pos6'] = Pose(Point(-1.173, 1.053, 0.000), Quaternion(0.000, 0.000, 0.985, 0.172))
        #locations['pos7'] = Pose(Point(-2.557, 1.505, 0.000), Quaternion(0.000, 0.000, 0.976, 0.218))
